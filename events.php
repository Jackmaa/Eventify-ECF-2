...
?>
<div class="position-sticky bg-dark d-flex justify-content-end top-0"> <!-- Sticky container for the add event button -->
  <button type="button" class="btn btn-lg" data-bs-toggle="modal" data-bs-target="#eventModal" data-toggle="tooltip" data-placement="left" title="Add an Event!"> <!-- Button to open the modal to add a new event -->
