...
<head>
    ...
    <meta name="description" content="Eventify is a web application that allows users to create and manage events.">
...
<header>
    ...
    <div class="d-flex justify-content-center p-5 w-100 col-12">
        <div class="text-center">
            ...
            <button type="button" id="login-btn" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#loginModal">
                LOGIN
            </button>
            <!-- Button trigger modal SignUp -->
            <button type="button" id="signup-btn" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#signUp">
                SIGN UP
            </button>
        </div>
    </div>
